...
require(knitr)
opts_knit$set(root.dir = normalizePath('~/Desktop/work/survey16S/tenyearSurvey16SGrass/NEW'))
```


```{r, set up directories for analyses, include=FALSE}
library(readr)
# Set data/output directories
root_dir <- "~/Desktop/work/survey16S/tenyearSurvey16SGrass/NEW"
data_dir <- "~/Desktop/work/survey16S/tenyearSurvey16SGrass/NEW"
output_dir <-"~/Desktop/work/survey16S/tenyearSurvey16SGrass/NEW"
knitr::opts_knit$set(root_dir)
```
...
```{r check current workdirectory, echo=TRUE, include=TRUE, results='hide'}
getwd()
```
##### Set the working directory you would like to use

```{r set workdirectory, echo=TRUE, include=TRUE, results='hide'}
setwd("~/Desktop/work/survey16S/tenyearSurvey16SGrass/NEW")
```
...
hdf5_biom <- read_hdf5_biom("~/Desktop/work/survey16S/tenyearSurvey16SGrass/NEW/ec6392f5-8036-4239-99a1-e15704f78c61/data/feature-table.biom")
...
taxonomy <- read.delim("~/Desktop/work/survey16S/tenyearSurvey16SGrass/NEW/4b1e5e15-0404-4fd2-86a5-463aac965a79/data/taxonomy.tsv", row.names=1)
```

##### Read in the metadata
```{r read in metadata,echo=TRUE, include= TRUE, results='hide'}
metadata <- read.delim("~/Desktop/work/survey16S/tenyearSurvey16SGrass/NEW/samples-to-keepNEW.tsv", stringsAsFactors=TRUE, row.names = 1)
names(metadata)
```
